...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 23 2019 г., 23:00
...
INSERT INTO `salary` (`id`, `worker_id`, `bonus`, `text`) VALUES
(1, 2, 1000, ''),
(2, 13, 1000, ''),
(3, 14, 1000, ''),
(6, 7, 1000, ''),
(7, 8, 1000, ''),
(15, 2, 1000, 'За красивое имя'),
(16, 6, 1000, 'За красивое имя'),
(17, 7, 1000, 'За красивое имя'),
(18, 13, 1000, 'За красивое имя');
...
(1, 'Юрий', 'Карась', 2, 20000, NULL),
(2, 'Анастасия', 'Белая', 2, 30000, NULL),
(3, 'Екатерина', 'Неустроева', 1, 40000, NULL),
(4, 'Алина', 'Таранина', 1, 30000, NULL),
(5, 'Анна', 'Бахмет', 3, 30000, NULL),
(6, 'Анастасия', 'Малащицкая', 3, 32000, NULL),
(7, 'Андрей', 'Леманов', 2, 40000, 'начальник'),
(8, 'Женя', 'Новиков', 1, 35000, 'работник'),
